...
class App extends (0, _yuhyeon.Component) {
    render() {
...
},{"./core/yuhyeon":"1l8pw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/TheHeader":"3Cyq4","./components/TheFooter":"b3x3c"}],"1l8pw":[function(require,module,exports) {
///// Component /////
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
class TheHeader extends (0, _yuhyeon.Component) {
    constructor(){
        super({
            tagName: "header",
            state: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../core/yuhyeon":"1l8pw"}],"b3x3c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
...
},{"../core/yuhyeon":"1l8pw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../components/Headline":"gaVgo","../components/Search":"jqPPz","../components/MovieList":"8UDl3","../components/MovieListMore":"3ZUar"}],"gaVgo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
class Headline extends (0, _yuhyeon.Component) {
    render() {
...
class Search extends (0, _yuhyeon.Component) {
    render() {
        ...
        this.el.innerHTML = /* html */ `
      <input value="${(0, _movieDefault.default).state.searchText}" placeholder="Enter the movie title to search for english!" />
...
},{"../core/yuhyeon":"1l8pw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../store/movie":"kq1bo"}],"kq1bo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "searchMovies", ()=>searchMovies);
parcelHelpers.export(exports, "getMovieDetails", ()=>getMovieDetails);
var _yuhyeon = require("../core/yuhyeon");
const store = new (0, _yuhyeon.Store)({
    searchText: "",
    page: 1,
    pageMax: 1,
    movies: [],
...
const getMovieDetails = async (id)=>{
    try {
        const res = await fetch(`https://omdbapi.com/?apikey=d4861326&i=${id}&plot=full`);
...
},{"../core/yuhyeon":"1l8pw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8UDl3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
var _movie = require("../store/movie");
...
class MovieList extends (0, _yuhyeon.Component) {
    constructor(){
        super();
...
},{"../core/yuhyeon":"1l8pw","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./MovieItem":"fAzE8"}],"fAzE8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
class MovieItem extends (0, _yuhyeon.Component) {
    constructor(props){
        super({
            props,
            tagName: "a"
...
},{"../core/yuhyeon":"1l8pw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3ZUar":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class MovieListMore extends (0, _yuhyeon.Component) {
    constructor(){
        super({
            tagName: "button"
        });
...
},{"../core/yuhyeon":"1l8pw","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1LTyN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _yuhyeon = require("../core/yuhyeon");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class Movie extends (0, _yuhyeon.Component) {
    async render() {
